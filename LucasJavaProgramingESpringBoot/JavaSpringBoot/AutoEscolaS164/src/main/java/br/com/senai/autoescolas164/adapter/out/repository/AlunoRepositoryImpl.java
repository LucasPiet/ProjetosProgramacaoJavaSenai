...
import br.com.senai.autoescolas164.adapter.out.repository.persist.AlunoJpaRepository;
...
public class AlunoRepositoryImpl implements AlunoRepository {
    ...
    public Aluno save(Aluno aluno) {
        ...
        AlunoEntity salve = jpaRepository.save(entity);
        return entityMapper.toDomain(salve);
    }
